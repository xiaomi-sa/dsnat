...
extern int ipvs_add_laddr(ipvs_zone_t *zone, ipvs_laddr_t * laddr);
extern int ipvs_del_laddr(ipvs_zone_t *zone, ipvs_laddr_t * laddr);
extern struct ip_vs_get_laddrs *ipvs_get_laddrs(ipvs_zone_entry_t *zone);
